<?php
            ...
            //Variaveis Locais
            $Email = $GetPost['email_juridica'];
            $Nome = $GetPost['nome_juridica'];
            $Cnpj = $GetPost['cnpj_juridica'];
            $Endereco = $GetPost['end_juridica'];
            $Cep = $GetPost['cep_juridica'];
            $Cidade = $GetPost['cidade_juridica'];
            $Uf = $GetPost['uf_juridica'];
            ...
            $Mailer->Subject = "Parceria Pessoa Fisica";
            $Mailer->Body = "Parceria Pessoa Juridica <br> Nome: $Nome <br> E-Mail: $Email  <br> Telefone: $Telefone <br> Cnpj: $Cnpj <br>Endereco: $Endereco <br> Cidade: $Cidade <br> CEP: $Cep <br> UF: $Uf";
...
<div class="container" align="center">
    ...
    <div class="btn-group">
        <button type="button" class="button"><span><a href="../index.html" style="color: whitesmoke">Voltar</a> </span></button>
    </div>
