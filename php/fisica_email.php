<?php
        ...
        //Variaveis Locais
        $Email = $GetPost['email'];
        $Nome = $GetPost['name_fisica'];
        $Telefone = $GetPost['telefone_fisica'];
        $Cpf = $GetPost['cpf_fisica'];
        $Cep = $GetPost['cep_fisica'];
        $Endereco = $GetPost['end_fisica'];
        $Cidade = $GetPost['cidade_fisica'];
        $Uf = $GetPost['uf_fisica'];
        ...
        $Mailer->Body = "Parceria Pessoa Fisica <br> Nome: $Nome <br> E-Mail: $Email <br> Telefone: $Telefone  <br> CPF: $Cpf <br>Endereco: $Endereco <br> Cidade: $Cidade <br> CEP: $Cep  <br> UF: $Uf";
