           ...
           <ul class="nav navbar-nav">
               ...
               <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#"><span class="fa fa-address-card-o"></span> Certificados <span class="caret"></span></a>
                   <ul class="dropdown-menu" id="segundo-menu">
                       ...
                       <li><a href="../ecpf/ecpf.html"><span class="fa fa-drivers-license"></span>&nbsp; e-CPF</a></li>
                       <li><a href="../epf/epf.html"><span class="fa fa-id-badge"></span>&nbsp;&nbsp;  e-PF</a></li>
                       <li><a href="../ecnpj/ecnpj.html"><span class="fa fa-briefcase"></span>&nbsp; e-CNPJ</a></li>
                       <li><a href="../nfe/nfe.html"><span class="fa fa-barcode"></span>&nbsp; NF-e</a></li>
                       <li><a href="../cte/cte.html"><span class="fa fa-truck"></span>&nbsp; CT-e</a></li>



                       <li><a href="../bancario/bancario.html"><span class="fa fa-bank"></span>&nbsp; CIP</a></li>
                       <li><a href="../oab/oab.html"><span class="fa fa-legal"></span> OAB</a></li>
                       <li><a href="../emedico/emedico.html"><span class="fa fa-stethoscope"></span>&nbsp; e-Medico</a></li>
                       <li><a href="../ssl/ssl.html"><span class="fa fa-shield"></span>&nbsp; SSL</a></li>
                       <li><a href="../mobile/mobile.html"><span class="fa fa-tablet"></span>&nbsp; Mobile</a></li>
                       <li><a href="../conectividade/conectividade.html"><span class="fa fa-handshake-o"></span>&nbsp; Conectividade</a></li>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        ...
        <div class="item active">
            <img src="img/contador.png" alt="Image">
...
<div class="space-60"></div>
        ...
        <!-- Container (Pricing Section cnpj) -->
        <div  class="container-fluid">

            <div class="container-fluid" align="center">
                <br>
                <h1 style="color: black">Menores Preços para contadores <span style="color: #014F5B;" class="fa fa-cart-arrow-down"></span> </h1>
            </div>
            ...
            <div class="text-center">
                <h4 style="color: #0b0b0b">Escolha o seu Certificado Digital e-CNPJ</h4>
            </div>
            ...
            <!--cnpj a1 15%-->
                ...
                <div class="panel panel-default text-center">
                    ...
                    <div class="panel-body">
                        ...
                        <p><strong>Certificado</strong> ICP-BRASIL</p>
                        <p><strong>Validade</strong> 1 ANO</p>

                        <p>
                            o e-CNPJ A1 tem validade de 1 ano. <BR>

                            <br><strong>IMPORTANTE:</strong> Esse certificado é emitido e armazenado diretamente no computador do titular.
                        </p>

                    </div>
                    <div class="panel-footer">
                        <h3>R$ 215,05</h3>
                        <button class="btn btn-lg"><a href="http://www.validcertificadora.com.br/e-CNPJ-A1.htm/EDC2B14A-476C-4002-9C4E-3D972295D30D/005370">Compra</a> </button>
                    </div>
                </div>
            </div>
            <!--cnpj a1 15%-->
            ...
            <!--cnpj a3 cartao 10%-->
                <div class="col-sm-4 col-xs-12">
                    <div class="panel panel-default text-center">
                        <div class="panel-heading">
                            <h1>e-CNPJ A3 em Cartão</h1>
                        </div>
                        <div class="panel-body">
                            <p><strong>usuarios</strong> 1 </p>
                            <p><strong>Certificado</strong> ICP-BRASIL</p>
                            <p><strong>Validade</strong> 1 ANO</p>

                            <p>  Esse certificado digital e-CNPJ A3 em Cartão tem validade de 1 ano.<br>

                                <br><strong>IMPORTANTE:</strong> VERIFIQUE A COMPATIBILIDADE DOS SISTEMAS OPERACIONAIS COM OS DISPOSITIVOS DE ARMAZENAMENTO, NA ÁREA DE DOWNLOAD/SUPORTE.
                        ...
                        <div class="panel-footer">
                            <h3>R$ 272,70</h3>
                            <button class="btn btn-lg"><a href="http://www.validcertificadora.com.br/e-CNPJ-A3-de-1-ano-em-cartao.htm/6650A6CF-3DC2-47E6-84A3-152003FBDC5D/005370">Compra</a> </button>
                        </div>
                    </div>
                </div>
            <!--cnpj a3 cartao 10%-->
            ...
            <!--cnpj a3 token 10%-->
                ...
                <div class="panel panel-default text-center">
                    ...
                    <div class="panel-body">
                        ...
                        <p>  Esse certificado digital e-CNPJ A3 em Token tem validade de 1 ano.<br>
                    ...
                    <div class="panel-footer">
                        <h3>R$ 405,90</h3>
                        <button class="btn btn-lg"><a href="http://www.validcertificadora.com.br/e-CNPJ-A3-de-1-ano-em-token.htm/6650A6CF-3DC2-47E6-84A3-152003FBDC5D/005370">Compra</a> </button>
                    </div>
                </div>
            </div>
            <!--cnpj a3 token 10%-->
         ...
         <div class="space-50"></div>
         <!-- Container (Pricing Section ecpf) -->
         <div  class="container-fluid">

             <div class="space-30"></div>

             <div class="text-center">
                 <h4>Escolha o seu Certificado Digital e-CPF</h4>
             </div>
             ...
             <div class="col-sm-4 col-xs-12">
                 <div class="panel panel-default text-center">
                     ...
                     <div class="panel-body">
                         ...
                         <p> Esse certificado digital e-CPF A1 tem validade de 1 ano.<br>
                             <br>
                             <strong>IMPORTANTE:</strong> Esse certificado é emitido e armazenado diretamente no computador do titular.</p>
                     </div>
                     <div class="panel-footer">
                         <h3>R$ 147,05</h3>
                         <button class="btn btn-lg"><a href="http://www.validcertificadora.com.br/e-CPF-A1.htm/EDC2B14A-476C-4002-9C4E-3D972295D30D/005370">Compra</a> </button>
                     </div>
                 </div>
             </div>
             <!--ecpf a1 15%-->
             ...
             <div class="col-sm-4 col-xs-12">
                 <div class="panel panel-default text-center">
                     ...
                     <div class="panel-body">
                         ...
                         <p>  Esse certificado digital e-CPF A3 em Cartão tem validade de 1 ano.<br>
                     ...
                     <div class="panel-footer">
                         <h3>R$ 200,70</h3>
                         <button class="btn btn-lg"><a href="http://www.validcertificadora.com.br/e-CPF-A3-de-1-ano-em-cartao.htm/6650A6CF-3DC2-47E6-84A3-152003FBDC5D/005370">Compra</a> </button>
                     </div>
                 </div>
             </div>
             <!--ecpf a3 cartao 10%-->
             ...
             <div class="col-sm-4 col-xs-12">
                 <div class="panel panel-default text-center">
                     ...
                     <div class="panel-body">
                         ...
                         <p>  Esse certificado digital e-CPF A3 em Token tem validade de 1 ano.<br>
                     ...
                     <div class="panel-footer">
                         <h3>R$ 335,70</h3>
                         <button class="btn btn-lg"><a href="http://www.validcertificadora.com.br/e-CPF-A3-de-1-ano-em-token.htm/6650A6CF-3DC2-47E6-84A3-152003FBDC5D/005370">Compra</a> </button>
                     </div>
                 </div>
             </div>
             <!--ecpf token 10%-->
