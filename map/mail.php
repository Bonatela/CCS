...
//Incluir PHP MAILER
include_once '../php/mailer/src/SMTP.php';
include_once '../php/mailer/src/PHPMailer.php';
...
$Mailer->Body = " Nome: $Nome <br>  E-mail: $Email <br> Assunto:  $Assunto <br> Mensagem: $Mensagem";
...
<head>
    ...
    <!--CSS -->
    <link rel="stylesheet" href="../php/return/css/css.css">
...
<div class="container" align="center">
    ...
    <div class="btn-group">
        <button type="button" class="button"><span style="color:#fff"><a href="mail.html" style="color: whitesmoke">Voltar</a> </span></button>
    </div>
